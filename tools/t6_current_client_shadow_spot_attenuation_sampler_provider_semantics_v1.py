...
def main():
    ...
    req(arr["client"]["sha256"]==pairs["client"]["sha256"]==SHA,"client SHA disagreement")
    req("SHA-classified current-client" in light.get("authority",""),"light provider authority drift")
