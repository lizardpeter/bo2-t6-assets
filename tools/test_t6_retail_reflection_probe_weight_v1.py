...
EXPECTED_SUMMARY={
 ...
 'alphaBiasBits':'358637bd','firstMulDistance3Count':5858,'firstMulDistance4Count':30,
...
def validate(d):
 ...
 assert d['equation']=={'decodedProbeRgb':'probe.rgb * (probe.a + 1e-6)','alphaBiasBits':'358637bd'}
