...
with tempfile.TemporaryDirectory() as td:
    ...
    c=td/"c.json"; c.write_text(json.dumps({"format":"t6-third-person-animation-compatibility-v2","bodyModel":"body_a","selectorProfile":{"id":"p1","selectors":{"weaponclass":"smg","nextWeaponclass":"smg","playerAnimType":"default","nextPlayerAnimType":"default"}},"allRequiredTracksCompatible":True,"ownershipResolvedFromRetail":True,"resolutionFormat":"t6-playeranim-retail-resolution-v2","summary":{"x":1}})+"\n")
