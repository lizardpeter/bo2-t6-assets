...
class Cursor:
    ...
    def vdecl(self)->dict:
        s=self.take(116)
        # Retail T6 MaterialVertexDeclaration tail pointer array is zero in the retained PC fixtures.
    ...
    def technique(self)->dict:
        ...
        for pa in passes:
            ch={}
            # This child order is source-closed by complete TechniqueSet blocks in the retained shader census.
