...
PATTERNS={
 "constValue":lambda n:re.compile(rf"\b(?:input\.)?consts\s*\[\s*{n}\s*\]"),
 "constVersion":lambda n:re.compile(rf"\bconstVersions\s*\[\s*{n}\s*\]"),
 "codeImage":lambda n:re.compile(rf"\bcodeImages\s*\[\s*{n}\s*\]"),
}
