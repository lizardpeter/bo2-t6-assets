...
def main():
 ...
 out={
  ...
  "proofBoundary":"Exact decoded current-client control-flow only. SKIPDATA pseudo-instructions are excluded from inbound-call classification. Descriptive target labels encode only already-proven caller roles. No source symbol, XZoneInfo field name, historical-retail identity, precedence rule, or Technique winner is inferred."
 }
